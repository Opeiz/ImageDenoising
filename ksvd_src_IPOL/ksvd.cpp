...
void ksvd_ipol(const double   sigma       ,
	...
	//! Assuming that img_noisy is in [0, 255]
    ...
    if (useT || floor(num_patches / T) > N2)
    {
        ...
        //! Learn dictionary
		ksvd_process(img_noisy, img_denoised, sub_patches, dictionary, sigma, N1, N2, N_iter, gamma, C, width, height, chnls, false);

        //! Denoising
        ksvd_process(img_noisy, img_denoised, patches, dictionary, sigma, N1, N2, 1, gamma, C, width, height, chnls, true);
    }
    else
    {
        //! Obtain the initial dictionary
        ...
        //! Denoising
        ksvd_process(img_noisy, img_denoised, patches, dictionary, sigma, N1, N2, N_iter, gamma, C, width, height, chnls, true);
    }
